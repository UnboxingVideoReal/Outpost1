...
public partial class Main : Node2D
{
    ...
    public override void _Process(double delta)
    {
        ...
        */
        SpawnBullet(true, new Vector2(2, 2), 500f, new Vector2(GetViewportRect().Size.X, 0), GetNode<CharacterBody2D>("Enigma").GlobalPosition, true, 10);
        SpawnBullet(true, new Vector2(2, 2), 500f, new Vector2(0, 0), GetNode<CharacterBody2D>("Enigma").GlobalPosition, true, 10);
        SpawnBullet(true, new Vector2(2, 2), 500f, new Vector2(GetViewportRect().Size.X, GetViewportRect().Size.Y), GetNode<CharacterBody2D>("Enigma").GlobalPosition, true, 10);
        SpawnBullet(true, new Vector2(2, 2), 500f, new Vector2(0, GetViewportRect().Size.Y), GetNode<CharacterBody2D>("Enigma").GlobalPosition, true, 10);
